...
#'
#' @param x The values of the distribution
#' @param mu The mu value of the normal distribution.
#' @param sig The sigma value of the normal distribution.
#' @param ... More values which can be entered
#'
#' @return Makes a plot of all of the values in terms of a normal distribution
#' @return Returns a list of values such as the max likely-hood, coordinates, and values.
#' @export
#'
#' @examples
